...
csv_files<- list.files(path=project.input.dir, pattern = "Toluene_PreProcessed_Plates-9", recursive = T, full.names = T) 

#Make vector for what the names of the basenames of the data files
data_frame_names<-gsub("-9.csv","",basename(csv_files))
